...
if [[ "$1" == "consumer" ]]; then
  ...
  java -Xms6536M -Xmx6536M -jar -Dserver.port=20000 -Detcd.url=http://etcd:2379 /root/dists/ca.jar > /root/logs/ca.log 2>&1
  ...
  pypy /root/dists/pa_register.py  --port=30000 --etcd=etcd --weight=16
  /root/dists/a.out > /root/logs/pas.log 2>&1
elif [[ "$1" == "provider-medium" ]]; then
  echo "Starting medium provider agent..."
  pypy /root/dists/pa_register.py  --port=30000 --etcd=etcd --weight=23
